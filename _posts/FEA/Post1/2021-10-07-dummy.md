...
As can be seen in macro code given above, I didn't mesh in triangular shape. If i use triangular shape for mesh, ANSYS would be create to node at the middle of the area.  
