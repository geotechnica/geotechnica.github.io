...
/GCMD,2, PLNSOL,U,X,0,1	! Plot the deflection USUM
/GCMD,3, PLNSOL,U,Y,0,1	! Plot the equivalent stress
/GCMD,4, PLVECT,U,X	! Plot the equivalent strain
```

As can be seen in macro code given above, I didn't mesh in triangular shape. If i use triangular shape for mesh, ANSYS would be create to node at the middle of the area. That's why I didn't mesh in tria shape. At the end of the analysis, I got some solution given below.   
